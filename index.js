...
import { ANCHOR_OUTPUT_PROTOCOL_SYSTEM_PROMPT, OUTPUT_PROTOCOL_SYSTEM_PROMPT } from './generation/output-protocol.js?ver=0.2.5';
import { normalizeGeneratedResult } from './generation/output-result.js?ver=0.2.5';
import { applyAnchorInsertions, buildAnchorPreviewSegments, isAnchorInsertionEnabled, locateAnchorInsertions } from './injection/anchor-insertion.js?ver=0.2.5';
import { normalizeStreamOutputPreview } from './generation/stream-output-preview.js?ver=0.2.5';
import { composeTaskInstruction } from './generation/task-instruction.js?ver=0.2.5';
import { CHAT_HISTORY_RANGE_RECENT, CHAT_HISTORY_RANGE_VISIBLE, normalizeChatHistoryRangeMode, normalizeRecentMessageCount } from './generation/chat-history-range.js?ver=0.2.5';
import { renderPromptTemplate } from './generation/template-compat.js?ver=0.2.5';
import { replaceTavernHelperMacrosInMessages } from './generation/tavern-helper-macros.js?ver=0.2.5';
...
} from './sources/source-selection.js?ver=0.2.5';
import { captureSchemeSnapshot, deleteScheme, findScheme, getWorldbookSchemeSourceNames, hydrateTavernWorldbookSelections, isWorldbookSchemeSnapshotUsable, normalizeSchemeList, resolveWorldbookPromptSelectionsForLoad, saveScheme } from './settings/scheme-utils.js?ver=0.2.5';
import { applyComponentSchemeSnapshot, captureComponentSchemeSnapshot } from './settings/component-schemes.js?ver=0.2.5';
import { readOpenAiStream } from './api/stream-utils.js?ver=0.2.5';
import { normalizeApiRetryCount, withApiRetries } from './api/api-retry.js?ver=0.2.5';
import { stripConfiguredBlocks } from './injection/tag-rules.js?ver=0.2.5';
import { filterWorldbookPromptItems, normalizeWorldbookActivationMode, splitWorldbookKeywords } from './sources/worldbook-scan.js?ver=0.2.5';
import { getWorldbookGenerationIssue, getWorldbookRawName, reconcileWorldbookEntryRecords, removeWorldbookEntryRecord, removeWorldbookSourceRecords } from './sources/worldbook-identity.js?ver=0.2.5';
import { reconcilePresetEntryRecords, reconcilePresetSchemeRecords } from './sources/preset-identity.js?ver=0.2.5';
import { getWorldInfoSettings } from '../../../world-info.js?ver=0.2.5';
import { createGenerationErrorRecord, markGenerationResponseError } from './generation/generation-error.js?ver=0.2.5';
import { getNotificationMethod } from './ui/notification-utils.js?ver=0.2.5';
import {
  FLOOR_PANEL_STATUS,
...
} from './ui/message-floor-panel.js?ver=0.2.5';
import { getGenerationConflictAction } from './generation/generation-entry.js?ver=0.2.5';
import { loadGenerationHistory, recordGenerationResult, updateGenerationHistoryEntry } from './generation/generation-history.js?ver=0.2.5';
import {
...
} from './generation/multi-task-state.js?ver=0.2.5';
import { createMultiTaskRunPlan, runMultiTaskQueue } from './generation/multi-task-runner.js?ver=0.2.5';
import { createMultiTaskInjectionQueue } from './generation/multi-task-injection-queue.js?ver=0.2.5';
import { canEnqueueTaskAutoInjection, createTaskOrderInjectionCoordinator } from './generation/multi-task-auto-injection.js?ver=0.2.5';
import { resolveMultiTaskRuntimeSettings } from './generation/multi-task-runtime.js?ver=0.2.5';
import { renderGenerationModeSwitch, renderMultiTaskWorkspace } from './ui/multi-task-workspace.js?ver=0.2.5';
import {
...
} from './sources/theater-library.js?ver=0.2.5';
import {
...
} from './generation/auto-generation-trigger.js?ver=0.2.5';
import { resolveFloatingBallPosition } from './ui/floating-ball-position.js?ver=0.2.5';
import { hasFloatingBallDragStarted, resolveFloatingBallDock } from './ui/floating-ball-gesture.js?ver=0.2.5';
import { normalizeFloatingBallVisualState, resolveFloatingBallRenderedState, resolveMultiTaskFloatingBallVisualState } from './ui/floating-ball-state.js?ver=0.2.5';
import { isFloatingBallExternallyManaged, markFloatingBallCompatible } from './ui/floating-ball-compat.js?ver=0.2.5';
import { renderBrandMark } from './ui/brand-mark.js?ver=0.2.5';
import { getGenerationInjectionModeHelp } from './ui/generation-settings.js?ver=0.2.5';
import { getThemeClassName, getThemePresentation, nextThemeMode, normalizeThemeMode } from './ui/theme-mode.js?ver=0.2.5';
import {
  buildApiRequestParts,
  parseApiAdditionalParameters,
  parseApiNumericSettings,
  serializeRequestHeadersYaml,
} from './api/api-request-parameters.js?ver=0.2.5';
import {
...
} from './sources/prompt-source-cache.js?ver=0.2.5';
import { TASK_PLACEMENT_AFTER_CHAT_HISTORY, resolveTaskPlacementSelection } from './settings/task-placement.js?ver=0.2.5';
import { createStreamPreviewController } from './ui/stream-preview.js?ver=0.2.5';
import { getPreviewLayout, isPreviewNearBottom } from './ui/preview-sizing.js?ver=0.2.5';
import { renderHelpGuide } from './ui/help-guide.js?ver=0.2.5-help-tour-2026090805';
import { HELP_TOUR_STEPS, renderHelpTour } from './ui/help-tour.js?ver=0.2.5-help-tour-2026090805';
import {
...
} from './sources/worldbook-runtime-state.js?ver=0.2.5';
import { buildLibraryExportFilename, createLibraryExportPackage, importLibraryPackage, toggleLibraryExportSelection } from './sources/library-transfer.js?ver=0.2.5';
import { listImportTargetGroups, resolveImportTargetGroupId } from './sources/import-target-groups.js?ver=0.2.5';
import { buildEditedPresetExport, buildPresetExportFilename, getNativeTavernPreset } from './sources/preset-export.js?ver=0.2.5';
import { resolveTavernProfile } from './generation/tavern-profile.js?ver=0.2.5';
import {
...
} from './settings/chat-worldbook-binding.js?ver=0.2.5';
import { applyMultiTaskSchemeSnapshot, captureMultiTaskSchemeSnapshot } from './settings/multi-task-schemes.js?ver=0.2.5';
import { getChatMultiTaskSchemeId, setChatMultiTaskSchemeId } from './settings/chat-multi-task-binding.js?ver=0.2.5';
import { buildDataManagementModel, clearSettingsDataCategory, formatByteSize } from './settings/data-management.js?ver=0.2.5';
import { buildTagCleanupImportSummary, createTagCleanupExportPackage, mergeTagCleanupImport } from './settings/tag-cleanup-transfer.js?ver=0.2.5';
