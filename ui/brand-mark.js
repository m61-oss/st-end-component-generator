export function renderBrandMark(context = 'default') {
  ...
  if (contextClass === 'menu') {
    return `<svg class="st-esg-brand-mark st-esg-brand-mark-menu" viewBox="0 0 48 48" aria-hidden="true" focusable="false"><path class="st-esg-brand-mark-menu-path" d="M8 13 19 20.56M29 27.44 40 35V13L29 20.56M19 27.44 8 35V13"></path><path class="st-esg-brand-mark-bridge" d="m20.5 26.7 7-5"></path></svg>`;
  }
